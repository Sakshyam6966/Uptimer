...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    let mybutton = new MessageButton() // prettier
      .setStyle('url').setLabel("Invite Link").setURL("https://discord.com/api/oauth2/authorize?client_id=849523433657466890&permissions=2147875904&scope=bot") // XDD Change this
    ...
    return message.channel.send({
      ...
      .setDescription(
        "**Uptimer** Is a Free Discord Bot That Allows You To Make Your Projects Oline 24/7 Just By Using A Single Command."
      )
      //.setColor("#a1eb34")
      .setColor("RANDOM")
      .addField(
